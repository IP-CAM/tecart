...
<!-- breadcrumbs old place -->
  ...
  <div class="product-info">
    ...
    <div class="left">
      <?php if ($thumb) { ?>
      <div class="image"><?php echo $sticker; ?><a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" class="colorbox" rel="colorbox"><img src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" id="image" /></a></div>
      <?php } ?>
      <?php if ($images) { ?>
    ...
    <div class="right">
      ...
      <div class="review">
        ...
        <div class="pluso" data-background="transparent" data-options="small,round,line,horizontal,nocounter,theme=04" data-services="vkontakte,odnoklassniki,moimir,facebook,twitter,google"></div>
		  <div class="wish-links"><a onclick="addToWishList('<?php echo $product_id; ?>');"><i class="fa fa-heart-o"></i> <?php echo $button_wishlist; ?></a> 
          <a onclick="addToCompare('<?php echo $product_id; ?>');"> <i class="fa fa-files-o"></i> <?php echo $button_compare; ?></a></div>
  ...
  <div id="tab-review" class="tab-content">
    ...
    <div id="add-review">
      ...
      <div>
        ...
        <!-- <span class="txt-message"><?php echo $text_note; ?></span> -->
      </div>

      <div class="review-rating">
        <?php echo $entry_rating; ?> <b><?php echo $entry_bad; ?></b>
        <input type="radio" name="rating" value="1" />
        <input type="radio" name="rating" value="2" />
        <input type="radio" name="rating" value="3" />
        <input type="radio" name="rating" value="4" />
        <input type="radio" name="rating" value="5" />
        <b><?php echo $entry_good; ?></b>
      </div>
