...
<div id="header">
  ...
  <div class="links"><a href="<?php echo $wishlist; ?>" id="wishlist-total"><i class="fa fa-heart"></i> <?php echo $text_wishlist; ?></a><a href="<?php echo $account; ?>"><i class="fa fa-user"></i> <?php echo $text_account; ?></a>
      <a href="<?php echo $checkout; ?>"><i class="fa fa-shopping-cart"></i> <?php echo $text_checkout; ?></a></div>
</div>
<?php if ($categories) { ?>
<div id="menu">
  <ul>
